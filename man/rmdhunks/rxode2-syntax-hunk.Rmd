...
optionally terminated by semi-colons `;` and optional comments
(comments are delimited by `#` and an end-of-line).
...
`rxode2` model functions assignment with `~` can also be overloaded
with a residual distribution specification.
