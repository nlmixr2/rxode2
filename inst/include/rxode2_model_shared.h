...
#define llikNbinom2(x, size, mu) _llikNbinom2(__llikSav, x, size, mu)
#define llikNbinom2Dmu(x, size, mu) _llikNbinom2Dmu(__llikSav, x, size, mu)
...
#define llikXNbinom2(i, x, size, mu) _llikNbinom2(__llikSavX(i), x, size, mu)
#define llikXNbinom2Dmu(i, x, size, mu) _llikNbinom2Dmu(__llikSavX(i), x, size, mu)
