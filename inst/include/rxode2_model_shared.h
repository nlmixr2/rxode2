...
#define __llikSavX (&_solveData->subjects[_cSub])->llikSave + (int)(i)*rxLlikSaveSize
...
#define llikXNorm(i, x, mu, sd) _llikNorm(__llikSavX, x, mu, sd)
#define llikXNormDmean(i, x, mu, sd) _llikNormDmean(__llikSavX, x, mu, sd)
#define llikXNormDsd(i, x, mu, sd) _llikNormDsd(__llikSavX, x, mu, sd)
#define llikXPois(i, x, l) _llikPois(__llikSavX, x, l)
#define llikXPoisDlambda(i, x, l) _llikPoisDlambda(__llikSavX, x, l)
#define llikXBinom(i, x, size, prob) _llikBinom(__llikSavX, x, size, prob)
#define llikXBinomDprob(i, x, size, prob) _llikBinomDprob(__llikSavX, x, size, prob)
#define llikXBeta(i, x, shape1, shape2) _llikBeta(__llikSavX, x, shape1, shape2)
#define llikXBetaDshape1(i, x, shape1, shape2) _llikBetaDshape1(__llikSavX, x, shape1, shape2)
#define llikXBetaDshape2(i, x, shape1, shape2) _llikBetaDshape2(__llikSavX, x, shape1, shape2)
#define llikXT(i, x, nu, mean, sd) _llikT(__llikSavX, x, nu, mean, sd)
#define llikXTDdf(i, x, nu, mean, sd) _llikTDdf(__llikSavX, x, nu, mean, sd)
#define llikXTDsd(i, x, nu, mean, sd) _llikTDsd(__llikSavX, x, nu, mean, sd)
#define llikXTDmean(i, x, nu, mean, sd) _llikTDmean(__llikSavX, x, nu, mean, sd)
#define llikXChisq(i, x, nu) _llikChisq(__llikSavX, x, nu)
#define llikXChisqDdf(i, x, nu) _llikChisqDdf(__llikSavX, x, nu)
#define llikXExp(i, x, rate) _llikExp(__llikSavX, x, rate)
#define llikXExpDrate(i, x, rate) _llikExpDrate(__llikSavX, x, rate)
#define llikXF(i, x, df1, df2) _llikF(__llikSavX, x, df1, df2)
#define llikXFDdf1(i, x, df1, df2) _llikFDdf1(__llikSavX, x, df1, df2)
#define llikXFDdf2(i, x, df1, df2) _llikFDdf2(__llikSavX, x, df1, df2)
#define llikXGeom(i, x, p) _llikGeom(__llikSavX, x, p)
#define llikXGeomDprob(i, x, p) _llikGeomDp(__llikSavX, x, p)
#define llikXUnif(i, x, alpha, beta) _llikUnif(__llikSavX, x, alpha, beta)
#define llikXUnifDalpha(i, x, alpha, beta) _llikUnifDalpha(__llikSavX, x, alpha, beta)
#define llikXUnifDbeta(i, x, alpha, beta) _llikUnifDbeta(__llikSavX, x, alpha, beta)
#define llikXWeibull(i, x, shape, scale) _llikWeibull(__llikSavX, x, shape, scale)
#define llikXWeibullDshape(i, x, shape, scale) _llikWeibullDshape(__llikSavX, x, shape, scale)
#define llikXWeibullDscale(i, x, shape, scale) _llikWeibullDscale(__llikSavX, x, shape, scale)
#define llikXGamma(i, x, shape, rate) _llikGamma(__llikSavX, x, shape, rate)
#define llikXGammaDshape(i, x, shape, rate) _llikGammaDshape(__llikSavX, x, shape, rate)
#define llikXGammaDrate(i, x, shape, rate) _llikGammaDrate(__llikSavX, x, shape, rate)
#define llikXCauchy(i, x, location, scale) _llikCauchy(__llikSavX, x, location, scale)
#define llikXCauchyDlocation(i, x, location, scale) _llikCauchyDlocation(__llikSavX, x, location, scale)
#define llikXCauchyDscale(i, x, location, scale) _llikCauchyDscale(__llikSavX, x, location, scale)
