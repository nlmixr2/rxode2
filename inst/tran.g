...
statement
  ...
  | splitInfusionBolus_statement end_statement
  | splitBolusInfusion_statement end_statement
...
identifier_r_extra: 'alag' | 'f'| 'F' | 'rate' | 'dur' | 'lag' | 'past' |
  ...
  'splitInfusionBolus' | 'splitBolusInfusion' | 'replace' | 'reset';
