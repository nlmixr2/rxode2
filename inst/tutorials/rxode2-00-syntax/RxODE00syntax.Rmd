...
More information about the event specification for the duration/rate
  ...
  vignette](https://nlmixrdevelopment.github.io/rxode2/articles/rxode2-event-types.html).
...
the [`linCmt()`
vignette](https://nlmixrdevelopment.github.io/rxode2/articles/rxode2-model-types.html#solved-compartment-models)
...
- special model event changes including **bioavailability**
  ...
  events vignette](https://nlmixrdevelopment.github.io/rxode2/articles/rxode2-event-types.html).
