...
Now that you've mastered the basic syntax of `rxode2` models, it's time to learn how to interact with them. In the next tutorial, **[rxode2 events](rxode01events.Rmd)**, you will discover how to create event tables to define dosing schedules and sampling times for your simulations.
