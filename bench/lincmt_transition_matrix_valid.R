...
gradModel <- function(ncmt, oral0, trans, dirs) {
  args <- sprintf("rx__PTR__, t, 1, %d, %d, %%d, %%d, %d, p1, v1, p2, p3, p4, p5, ka", ncmt, oral0, trans)
  lines <- c(
...
cases <- list(
  list(
    ...
    oral0 = 0,
    trans = 1,
    p = c(p1 = 2.1, v1 = 21, p2 = 0, p3 = 0, p4 = 0, p5 = 0, ka = 0),
    dirs = 0:1
  ),
  list(
    nm = "1cmt oral t1",
    ...
    oral0 = 1,
    trans = 1,
    p = c(p1 = 2.1, v1 = 21, p2 = 0, p3 = 0, p4 = 0, p5 = 0, ka = 1.3),
    dirs = 0:2
  ),
  list(
    nm = "2cmt iv t1",
    ...
    oral0 = 0,
    trans = 1,
    p = c(p1 = 2.1, v1 = 21, p2 = 3.3, p3 = 43, p4 = 0, p5 = 0, ka = 0),
    dirs = 0:3
  ),
  list(
    nm = "2cmt oral t1",
    ...
    oral0 = 1,
    trans = 1,
    p = c(p1 = 2.1, v1 = 21, p2 = 3.3, p3 = 43, p4 = 0, p5 = 0, ka = 1.3),
    dirs = 0:4
  ),
  list(
    nm = "2cmt oral t2",
    ...
    oral0 = 1,
    trans = 2,
    p = c(p1 = 0.1, v1 = 21, p2 = 0.15, p3 = 0.08, p4 = 0, p5 = 0, ka = 1.3),
    dirs = 0:4
  ),
  list(
    nm = "3cmt iv t1",
    ...
    oral0 = 0,
    trans = 1,
    p = c(p1 = 2.1, v1 = 21, p2 = 3.3, p3 = 43, p4 = 0.9, p5 = 61, ka = 0),
    dirs = 0:5
  ),
  list(
    nm = "3cmt oral t1",
    ...
    oral0 = 1,
    trans = 1,
    p = c(p1 = 2.1, v1 = 21, p2 = 3.3, p3 = 43, p4 = 0.9, p5 = 61, ka = 1.3),
    dirs = 0:6
  )
)
...
regimens <- list(
  uniform = function() rxode2::et(rxode2::et(amt = 100, time = 0, cmt = 1), seq(0.25, 24, by = 0.25)),
  nonunif = function() rxode2::et(rxode2::et(amt = 100, time = 0, cmt = 1), cumsum(seq(0.05, 0.55, length.out = 96))),
  multi = function() rxode2::et(rxode2::et(amt = 100, time = 0, cmt = 1, ii = 12, addl = 3), seq(0.5, 48, by = 0.5)),
  infusion = function() rxode2::et(rxode2::et(amt = 100, time = 0, cmt = 1, rate = 20), seq(0.25, 24, by = 0.25))
)
...
for (cs in cases) {
  ...
  for (rn in names(regimens)) {
    ...
    s <- rxode2::rxSolve(mod, cs$p, ev, cores = 1L, addDosing = FALSE, linCmtSensType = "AD")
