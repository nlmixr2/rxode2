# 40x100 FOCEi fit cell for the value-memo A/B (sourced by
# bench/lincmt_value_memo_ab.R MODE=fit; rxode2 + nlmixr2est already
# loaded by the caller).  2-cmt oral, 3 etas, proportional error --
# the same family as the amortization benches.
runMemoFitCell <- function(nSub = 40L, nObs = 100L) {
  ...
  suppressWarnings(suppressMessages(
    nlmixr2est::nlmixr2(uiLin, dat, est = "focei", control = ctl)
  ))
}
