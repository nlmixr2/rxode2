...
designs <- list(
  uniform = function() rxode2::et(rxode2::et(amt = 100, time = 0, cmt = 1), seq(0.1, 100, by = 0.1)),
  multidose = function() {
  ...
  infusion = function() {
    rxode2::et(rxode2::et(amt = 100, time = 0, cmt = 1, dur = 4, ii = 24, addl = 3), seq(0.1, 100, by = 0.1))
  }
)
...
w <- reshape(
  res[, c("design", "ncmt", "nDir", "arm", "usPerObs")],
  idvar = c("design", "ncmt", "nDir"),
  timevar = "arm",
  direction = "wide"
)
