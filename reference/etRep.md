...
- n:
  ...
  The number of times to repeat the event table. Overrides `times`.

- wait:

  Waiting time between each repeated event table. By default there is no
  waiting, or wait=0
...
[`et`](https://nlmixr2.github.io/rxode2/reference/et.md), `etRep`,
