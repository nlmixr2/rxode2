...
This function applies the Rectified Linear Unit (ReLU) activation
function to the input numeric vector. The ReLU function is defined as
the positive part of its argument: \\f(x) = max(0, x)\\.
