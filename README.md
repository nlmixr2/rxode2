...
#> Error in UseMethod("et"): no applicable method for 'et' applied to an object of class "character"
```
...
x <- mod1 %>% rxSolve(ev)
#> 
#> Error in rxParseSetSilentErr(as.integer(length(capture.output(message(" "), : object '_rxode2_rxParseSetSilentErr' not found
x
