#ifndef ODE_RKO10_BRIDGE_H_
#define ODE_RKO10_BRIDGE_H_
#include "ode/ode_rko10.h"
class RxRko10 : public ode::OdeRko10 {
    t_dydt dydt_; int *full_neq_; rx_solving_options_ind *ind_; double t_stage_;
public:
    RxRko10(t_dydt dydt, int *full_neq, int neqOde, rx_solving_options_ind *ind, double *yp)
        : ode::OdeRko10((unsigned long)neqOde), dydt_(dydt), full_neq_(full_neq), ind_(ind), t_stage_(0.0)
    { set_sol_external(yp); }
protected:
