...
List rxModelVars_blank() {
  ...
  List strCmpParams;
  strCmpParams.attr("names") = CharacterVector::create();
  ret[30] = strCmpParams; // strCmpParams
  retN[30] = "strCmpParams";

  ret[31] = IntegerVector::create(0); // timeId
  retN[31] = "timeId";
...
SEXP rxSolve_(const RObject &obj, const List &rxControl,
  ...
  if (rxSolveDat->isRxSolve || rxSolveDat->isEnvironment){
    ...
    rx->linCmtNcmt = INTEGER(rxSolveDat->mv[RxMv_flags])[RxMvFlag_ncmt];
    ...
    if (method == 206 || method == 239 || method == 240 || method == 241 || method == 210 || method == 200 || method == 207 || method == 265 || method == 227 || method == 228 || method == 229 || method == 205 || method == 213 || method == 236 || method == 233 || method == 234 || method == 238 || method == 235 || method == 231 || method == 232 || method == 237 || method == 243 || method == 225 || method == 221) {
      ...
      int _fxOff = -1, _fpOff = -1, _dfOff = -1, _jpOff = -1, _jyOff = -1, _fxdOff = -1, _tauOff = -1, _dtauOff = -1;
