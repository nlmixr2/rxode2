...
SEXP rxSolve_(const RObject &obj, const List &rxControl,
  ...
  if (rxSolveDat->isRxSolve || rxSolveDat->isEnvironment){
    ...
    if (method == 206 || method == 239 || method == 240 || method == 241 || method == 210 || method == 200 || method == 207 || method == 265 || method == 227 || method == 228 || method == 229 || method == 205 || method == 213 || method == 236 || method == 233 || method == 234 || method == 238) {
