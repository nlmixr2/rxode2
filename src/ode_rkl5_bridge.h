#ifndef ODE_RKL5_BRIDGE_H_
#define ODE_RKL5_BRIDGE_H_
#include "ode/ode_rkl5.h"
class RxRkl5 : public ode::OdeRkl5 {
    t_dydt dydt_; int *full_neq_; rx_solving_options_ind *ind_; double t_stage_;
public:
    RxRkl5(t_dydt dydt, int *full_neq, int neqOde, rx_solving_options_ind *ind, double *yp)
