#ifndef ODE_RKS1110A_BRIDGE_H_
#define ODE_RKS1110A_BRIDGE_H_

#include "ode/ode_rks1110a.h"

class RxRks1110a : public ode::OdeRks1110a {
    t_dydt                  dydt_;
    int                    *full_neq_;
...
public:
    RxRks1110a(t_dydt dydt, int *full_neq, int neqOde,
            rx_solving_options_ind *ind, double *yp,
            long unsigned max_steps)
        : ode::OdeRks1110a((unsigned long)neqOde),
