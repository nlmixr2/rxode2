#ifndef ODE_RKTMY7S_H_
#define ODE_RKTMY7S_H_
...
class OdeRktmy7s : public OdeEmbedded, protected OdeRK, protected OdeERK {
public:
    OdeRktmy7s(unsigned long neq);
protected:
