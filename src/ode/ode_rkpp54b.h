#ifndef ODE_RKPP54B_H_
#define ODE_RKPP54B_H_
...
class OdeRkpp54b : public OdeEmbedded, protected OdeRK, protected OdeERK {
public:
    OdeRkpp54b(unsigned long neq);
protected:
