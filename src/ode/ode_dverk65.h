#ifndef ODE_DVERK65_H_
#define ODE_DVERK65_H_
...
class OdeDverk65 : public OdeEmbedded, protected OdeRK, protected OdeERK {
public:
    OdeDverk65(unsigned long neq);
protected:
