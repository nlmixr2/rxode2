...
// linCmtModelDouble
RObject linCmtModelDouble(double p1, double v1, double p2, double p3, double p4, double p5, double ka, NumericVector alastNV, NumericVector rateNV, const int ncmt, const int oral0, const int trans);
RcppExport SEXP _rxode2_linCmtModelDouble(SEXP p1SEXP, SEXP v1SEXP, SEXP p2SEXP, SEXP p3SEXP, SEXP p4SEXP, SEXP p5SEXP, SEXP kaSEXP, SEXP alastNVSEXP, SEXP rateNVSEXP, SEXP ncmtSEXP, SEXP oral0SEXP, SEXP transSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(linCmtModelDouble(p1, v1, p2, p3, p4, p5, ka, alastNV, rateNV, ncmt, oral0, trans));
    return rcpp_result_gen;
END_RCPP
}
// rxQs
