...
- [`rxode2()`](https://nlmixr2.github.io/rxode2/reference/rxode2.md)
  which creates the C code for fast ODE solving based on a [simple
...
- The event data, which can be:
  - a `NONMEM` or `deSolve` [compatible data
    ...
    or
  - created with
    [`et()`](https://nlmixr2.github.io/rxode2/reference/et.md) or
    [`eventTable()`](https://nlmixr2.github.io/rxode2/reference/eventTable.md)
    for [easy simulation of
...
- [`rxSolve()`](https://nlmixr2.github.io/rxode2/reference/rxSolve.md)
  which solves the system of equations using initial conditions and
...
![](reference/figures/README-intro-central-1.png)
...
![](reference/figures/README-intro-effect-1.png)
