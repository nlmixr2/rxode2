rxTest({
  test_that("test the matrices of the linear compartment solutions .solComp2", {
    v <- list(
      L = c(4.07546291005291, 0.0245370899470903),
      C1 = structure(c(0.759200006770939, -0.740571447916969, 0.240799993229061, 0.740571447916969), dim = c(2L, 2L)),
      C2 = structure(c(-0.246857149305656, 0.240799993229061, 0.246857149305656, 0.759200006770939), dim = c(2L, 2L))
    )

    expect_equal(.solComp2(k10 = 0.1, k12 = 3, k21 = 1), v)

    v <- list(
      L = c(5.8977832399092, 0.0122878774411843, 0.689928882649618),
      C1 = structure(
        c(
          0.86252789433926,
          -0.528317313419071,
  ...
  if (requireNamespace("pmxTools", quietly = TRUE)) {
    ...
    lapply(seq(.1, 10, by = 0.1), function(d) {
      test_that(paste0("test the one compartment linear compartment solution at ", d), {
        v <- f(d)
        expect_equal(stats::setNames(v["s"], NULL), stats::setNames(v["l"], NULL))
      })
    })
    ...
    f <- function(t, CL = 25, V = 20, DOSE = 100, tinf = 1) {
      ...
      l <- l$val
      c(s = pmxTools::calc_sd_1cmt_linear_infusion(CL = CL, V = V, t = t, dose = DOSE, tinf = tinf), l = l)
    }
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, DOSE = 100) {
      ...
      c(s = pmxTools::calc_sd_2cmt_linear_bolus(CL = CL, V = V, V2 = V2, Q = Q, t = dt, dose = DOSE), l = l)
    }
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, DOSE = 100, tinf = 1) {
      ...
      c(
        s = pmxTools::calc_sd_2cmt_linear_infusion(
          CL = CL,
          V = V,
          V2 = V2,
          Q = Q,
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, DOSE = 100) {
      ...
      c(
        s = pmxTools::calc_sd_3cmt_linear_bolus(CL = CL, V = V, V2 = V2, Q = Q, V3 = V3, Q3 = Q2, t = dt, dose = DOSE),
        l = l
      )
    }
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, ka = 2, DOSE = 100) {
      p1 <- CL
      v1 <- V
      p2 <- Q
      p3 <- V2
      ...
      c(
        s = pmxTools::calc_sd_3cmt_linear_oral_1(
          CL = CL,
          V = V,
          V2 = V2,
          Q = Q,
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, DOSE = 100, tinf = 1) {
      p1 <- CL
      v1 <- V
      p2 <- Q
      p3 <- V2
      ...
      c(
        s = pmxTools::calc_sd_3cmt_linear_infusion(
          CL = CL,
          V = V,
          V2 = V2,
          Q = Q,
    ...
    f0 <- function(dt, CL = 25, V = 20, DOSE = 100, alastNV = c(DOSE, 0, 0)) {
      p1 <- CL
      v1 <- V
      p2 <- 0
      p3 <- 0
    ...
    f <- function(dt, CL = 25, V = 20, DOSE = 100) {
      test_that(paste0("one compartment bolus t=", dt, ";CL=", CL, "; V=", V, "; DOSE=", DOSE), {
        t0 <- dt / 2
        f1 <- f0(t0, CL = CL, V = V, DOSE = DOSE)
        expect_equal(pmxTools::calc_sd_1cmt_linear_bolus(CL = CL, V = V, t = t0, dose = DOSE), f1$val)
        #
        f2 <- f0(t0, CL = CL, V = V, DOSE = DOSE, alastNV = f1$Alast)
        #
        f3 <- f0(t0 * 2, CL = CL, V = V, DOSE = DOSE)
        #
        expect_equal(pmxTools::calc_sd_1cmt_linear_bolus(CL = CL, V = V, t = dt, dose = DOSE), f3$val)
    ...
    f0 <- function(dt, CL = 25, V = 20, KA = 2, DOSE = 100, alastNV = c(DOSE, 0, 0, 0, 0, 0)) {
      p1 <- CL
      v1 <- V
      p2 <- 0
      p3 <- 0
    ...
    f <- function(dt, CL = 25, V = 20, KA = 2, DOSE = 100) {
      test_that(paste0("one compartment oral t=", dt, ";CL=", CL, "; V=", V, "; KA=", KA, "; DOSE=", DOSE), {
        t0 <- dt / 2
        f1 <- f0(t0, CL = CL, V = V, KA = KA, DOSE = DOSE)
        expect_equal(pmxTools::calc_sd_1cmt_linear_oral_1(CL = CL, V = V, ka = KA, t = t0, dose = DOSE), f1$val)
        #
        f2 <- f0(t0, CL = CL, V = V, KA = KA, DOSE = DOSE, alastNV = f1$Alast)
        #
        f3 <- f0(t0 * 2, CL = CL, V = V, KA = KA, DOSE = DOSE)
        #
        expect_equal(pmxTools::calc_sd_1cmt_linear_oral_1(CL = CL, V = V, ka = KA, t = dt, dose = DOSE), f3$val)
        # Value is in concentration
        expect_equal(f2$val, f3$val)
        # Unadjusted Jacobian
        expect_equal(f2$J, f3$J)
    ...
    f0i <- function(t, CL = 25, V = 20, DOSE = 100, tinf = 1, alastNV = rep(0, 3), rateNV = DOSE / tinf) {
      p1 <- CL
      v1 <- V
      p2 <- 0
      p3 <- 0
    ...
    f <- function(dt, CL = 25, V = 20, DOSE = 100, tinf = 1) {
      test_that(paste0("one compartment infusion t=", dt, ";CL=", CL, "; V=", V, "; tinf=", tinf, "; DOSE=", DOSE), {
        t0 <- dt / 2
        # See if more care is needed for IV comparison
        if (dt < tinf) {
          f1 <- f0i(t0, CL = CL, V = V, DOSE = DOSE, tinf = tinf)
          expect_equal(pmxTools::calc_sd_1cmt_linear_infusion(CL = CL, V = V, t = t0, dose = DOSE, tinf = tinf), f1$val)
          #
          f2 <- f0i(t0, CL = CL, V = V, DOSE = DOSE, tinf = tinf, alastNV = f1$Alast)
          #
          f3 <- f0i(t0 * 2, CL = CL, V = V, DOSE = DOSE)
          expect_equal(
            pmxTools::calc_sd_1cmt_linear_infusion(CL = CL, V = V, t = t0 * 2, dose = DOSE, tinf = tinf),
            f3$val
          )
          # Unadjusted Jacobian
          expect_equal(f2$J, f3$J)
          ...
          expect_equal(pmxTools::calc_sd_1cmt_linear_infusion(CL = CL, V = V, t = t0, dose = DOSE, tinf = tinf), f1$val)
          #
          f2 <- f0i(t0, CL = CL, V = V, DOSE = DOSE, tinf = tinf, rateNV = 0, alastNV = f1$Alast)
          expect_equal(
            pmxTools::calc_sd_1cmt_linear_infusion(CL = CL, V = V, t = t0 * 2, dose = DOSE, tinf = tinf),
            f2$val
          )
          ...
          tinf2 <- tinf - t0
          f2 <- f0i(t0, CL = CL, V = V, DOSE = DOSE, tinf = tinf2, rateNV = rateNV, alastNV = f1$Alast)
          expect_equal(
            pmxTools::calc_sd_1cmt_linear_infusion(CL = CL, V = V, t = t0 * 2, dose = DOSE, tinf = tinf),
            f3$val
          )
    ...
    f0 <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, DOSE = 100, alastNV = c(DOSE, rep(0, 9))) {
      p1 <- CL
      v1 <- V
      p2 <- Q
      p3 <- V2
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, DOSE = 100) {
      test_that(
        paste0("two compartment bolus t=", dt, ";CL=", CL, "; V=", V, "; Q=", Q, "; V2=", V2, "; DOSE=", DOSE),
        {
          t0 <- dt / 2
          f1 <- f0(t0, CL = CL, V = V, Q = Q, V2 = V2, DOSE = DOSE)
          expect_equal(pmxTools::calc_sd_2cmt_linear_bolus(CL = CL, V = V, V2 = V2, Q = Q, t = t0, dose = DOSE), f1$val)
          #
          f2 <- f0(t0, CL = CL, V = V, Q = Q, V2 = V2, DOSE = DOSE, alastNV = f1$Alast)
          #
          f3 <- f0(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, DOSE = DOSE)
          #
          expect_equal(
            pmxTools::calc_sd_2cmt_linear_bolus(CL = CL, V = V, V2 = V2, Q = Q, t = dt, dose = DOSE),
            f3$val
          )
          # Value is in concentration
          expect_equal(f2$val, f3$val)
    ...
    f0 <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, DOSE = 100, ka = 2, alastNV = c(DOSE, rep(0, 13))) {
      p1 <- CL
      v1 <- V
      p2 <- Q
      p3 <- V2
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, ka = 2, DOSE = 100) {
      test_that(
        ...
        ),
        {
          ...
          #
          f2 <- f0(t0, CL = CL, V = V, Q = Q, V2 = V2, ka = ka, DOSE = DOSE, alastNV = f1$Alast)
          #
          f3 <- f0(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, ka = ka, DOSE = DOSE)
          #
          expect_equal(
            pmxTools::calc_sd_2cmt_linear_oral_1(
              CL = CL,
      ...
      test_that(
        ...
        ),
        {
          ...
          if (dt < tinf) {
            ...
            expect_equal(
              pmxTools::calc_sd_2cmt_linear_infusion(
                CL = CL,
                V = V,
                Q = Q,
                V2 = V2,
            ...
            #
            f2 <- f0i(t0, CL = CL, V = V, V2 = V2, Q = Q, DOSE = DOSE, tinf = tinf, alastNV = f1$Alast)
            #
            ...
            rateNV <- DOSE / tinf
            f1 <- f0i(t0, CL = CL, V = V, V2 = V2, Q = Q, DOSE = DOSE, tinf = tinf, rateNV = rateNV)
            expect_equal(
              pmxTools::calc_sd_2cmt_linear_infusion(
                CL = CL,
                V = V,
            ...
            #
            f2 <- f0i(t0, CL = CL, V = V, V2 = V2, Q = Q, DOSE = DOSE, tinf = tinf, rateNV = 0, alastNV = f1$Alast)
            expect_equal(
              pmxTools::calc_sd_2cmt_linear_infusion(
                CL = CL,
                V = V,
            ...
            f3 <- f0i(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, DOSE = DOSE, tinf = tinf)
            expect_equal(
              pmxTools::calc_sd_2cmt_linear_infusion(
                CL = CL,
                V = V,
            ...
            rateNV <- DOSE / tinf
            f1 <- f0i(t0, CL = CL, V = V, Q = Q, V2 = V2, DOSE = DOSE, tinf = tinf, rateNV = rateNV)
            expect_equal(
              pmxTools::calc_sd_2cmt_linear_infusion(
                CL = CL,
                V = V,
    ...
    f0 <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, DOSE = 100, alastNV = c(DOSE, rep(0, 20))) {
      p1 <- CL
      v1 <- V
      p2 <- Q
      p3 <- V2
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, DOSE = 100) {
      test_that(
        ...
        ),
        {
          ...
          #
          f2 <- f0(t0, CL = CL, V = V, Q = Q, V2 = V2, Q2 = Q2, V3 = V3, DOSE = DOSE, alastNV = f1$Alast)
          #
          f3 <- f0(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, Q2 = Q2, V3 = V3, DOSE = DOSE)
          #
          expect_equal(
            pmxTools::calc_sd_3cmt_linear_bolus(
              CL = CL,
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, ka = 2, DOSE = 100) {
      test_that(
        ...
        ),
        {
          ...
          #
          f2 <- f0(t0, CL = CL, V = V, Q = Q, V2 = V2, Q2 = Q2, V3 = V3, ka = ka, DOSE = DOSE, alastNV = f1$Alast)
          #
          f3 <- f0(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, Q2 = Q2, V3 = V3, ka = ka, DOSE = DOSE)
          #
          expect_equal(
            pmxTools::calc_sd_3cmt_linear_oral_1(
              CL = CL,
    ...
    f <- function(dt, V = 40, CL = 18, V2 = 297, Q = 10, Q2 = 7, V3 = 400, DOSE = 100, tinf = 1) {
      test_that(
        ...
        ),
        {
          ...
          # See if more care is needed for IV comparison
          if (dt < tinf) {
            f1 <- f0i(t0, CL = CL, V = V, V2 = V2, Q = Q, V3 = V3, Q2 = Q2, DOSE = DOSE, tinf = tinf)
            expect_equal(
              pmxTools::calc_sd_3cmt_linear_infusion(
                CL = CL,
                V = V,
                Q = Q,
                V2 = V2,
            ...
            #
            f3 <- f0i(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, V3 = V3, Q2 = Q2, DOSE = DOSE)
            expect_equal(
              pmxTools::calc_sd_3cmt_linear_infusion(
                CL = CL,
                V = V,
            ...
            rateNV <- DOSE / tinf
            f1 <- f0i(t0, CL = CL, V = V, V2 = V2, Q = Q, V3 = V3, Q2 = Q2, DOSE = DOSE, tinf = tinf, rateNV = rateNV)
            expect_equal(
              pmxTools::calc_sd_3cmt_linear_infusion(
                CL = CL,
                V = V,
            ...
            f3 <- f0i(t0 * 2, CL = CL, V = V, Q = Q, V2 = V2, Q2 = Q2, V3 = V3, DOSE = DOSE, tinf = tinf)
            expect_equal(
              pmxTools::calc_sd_3cmt_linear_infusion(
                CL = CL,
                V = V,
            ...
            rateNV <- DOSE / tinf
            f1 <- f0i(t0, CL = CL, V = V, Q = Q, V2 = V2, V3 = V3, Q2 = Q2, DOSE = DOSE, tinf = tinf, rateNV = rateNV)
            expect_equal(
              pmxTools::calc_sd_3cmt_linear_infusion(
                CL = CL,
                V = V,
  ...
  testVal <- function(rx, val) {
    ...
    expect_equal(.getCmtNum(rx), state[val])
  }
  ...
  testInf <- function(rx, val) {
    ...
    state <- setNames(seq_along(state), state)
    .num <- .getCmtNum(rx)
    expect_equal(setNames(cmtSupportsInfusion_(.num, rxModelVars(rx)), names(.getCmtNum(rx))), val)
  }
  ...
  testOff <- function(rx, val) {
    ...
    state <- setNames(seq_along(state), state)
    .num <- .getCmtNum(rx)
    expect_equal(setNames(cmtSupportsOff_(.num, rxModelVars(rx)), names(.num)), val)
  }
  ...
  test_that("rxode2 parsing of linCmt() 1 compartment with ka", {
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 0L, numLin = 2L, depotLin = 1L))
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 4L, numLin = 2L, depotLin = 1L))
    ...
    testInf(
      ...
      c(
        ...
        central = TRUE,
        ce = TRUE,
        rx__sens_central_BY_p1 = FALSE,
        rx__sens_central_BY_v1 = FALSE,
  ...
  test_that("rxode2 parsing of linCmt() 1 compartment without ka", {
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 0L, numLin = 1L, depotLin = 0L))
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 2L, numLin = 1L, depotLin = 0L))

    testVal(rx, c("central", "ce", "rx__sens_central_BY_p1", "rx__sens_central_BY_v1"))

    testInf(rx, c(central = TRUE, ce = TRUE, rx__sens_central_BY_p1 = FALSE, rx__sens_central_BY_v1 = FALSE))

    testOff(rx, c(central = FALSE, ce = TRUE, rx__sens_central_BY_p1 = FALSE, rx__sens_central_BY_v1 = FALSE))

    expect_equal(rx$state, c("ce", "central", "rx__sens_central_BY_p1", "rx__sens_central_BY_v1"))
  ...
  test_that("rxode2 parsing of linCmt() 2 compartment without ka", {
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 0L, numLin = 2L, depotLin = 0L))
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 8L, numLin = 2L, depotLin = 0L))
    ...
    testInf(
      ...
      c(
        ...
        "rx__sens_central_BY_p1" = FALSE,
        "rx__sens_central_BY_v1" = FALSE,
        "rx__sens_central_BY_p2" = FALSE,
        "rx__sens_central_BY_p3" = FALSE,
        #
        "rx__sens_peripheral1_BY_p1" = FALSE,
        "rx__sens_peripheral1_BY_v1" = FALSE,
        "rx__sens_peripheral1_BY_p2" = FALSE,
        "rx__sens_peripheral1_BY_p3" = FALSE
      )
    )
  ...
  test_that("rxode2 parsing of linCmt() 2 compartment with ka", {
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 0L, numLin = 3L, depotLin = 1L))
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 11L, numLin = 3L, depotLin = 1L))
  ...
  test_that("rxode2 parsing of linCmt() 3 compartment without ka", {
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 0L, numLin = 3L, depotLin = 0L))
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 18L, numLin = 3L, depotLin = 0L))
    ...
    testInf(
      ...
      c(
        ...
        "rx__sens_central_BY_p2" = FALSE,
        "rx__sens_central_BY_p3" = FALSE,
        "rx__sens_central_BY_p4" = FALSE,
        "rx__sens_central_BY_p5" = FALSE,
        #
        "rx__sens_peripheral1_BY_p1" = FALSE,
        "rx__sens_peripheral1_BY_v1" = FALSE,
        "rx__sens_peripheral1_BY_p2" = FALSE,
        "rx__sens_peripheral1_BY_p3" = FALSE,
        "rx__sens_peripheral1_BY_p4" = FALSE,
        "rx__sens_peripheral1_BY_p5" = FALSE,
        #
        "rx__sens_peripheral2_BY_p1" = FALSE,
        "rx__sens_peripheral2_BY_v1" = FALSE,
        "rx__sens_peripheral2_BY_p2" = FALSE,
        "rx__sens_peripheral2_BY_p3" = FALSE,
        "rx__sens_peripheral2_BY_p4" = FALSE,
        "rx__sens_peripheral2_BY_p5" = FALSE
      )
    )
  ...
  test_that("rxode2 parsing of linCmt() 3 compartment with ka", {
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 0L, numLin = 4L, depotLin = 1L))

    testVal(rx, c("depot", "central", "ce", "peripheral1", "peripheral2"))

    testInf(rx, c("depot" = TRUE, "central" = TRUE, "ce" = TRUE, "peripheral1" = FALSE, "peripheral2" = FALSE))

    testOff(rx, c("depot" = FALSE, "central" = FALSE, "ce" = TRUE, "peripheral1" = FALSE, "peripheral2" = FALSE))
    ...
    expect_equal(getLinInfo_(rxModelVars(rx)), c(numLinSens = 22L, numLin = 4L, depotLin = 1L))
  ...
  if (requireNamespace("pmxTools", quietly = TRUE)) {
    test_that("rxode2 solving of 1 compartment steady state bolus", {
      ...
      expect_equal(pmxTools::calc_ss_1cmt_linear_bolus(t = 0, CL = 6, V = 25, dose = 600, tau = 24), f()$val)
    ...
    test_that("rxode2 solving of 1 compartment steady state for constant infusion", {
      ...
      expect_equal(f()$val, rxSolve(rx, e, addDosing = TRUE)$cp[1])

      v <- f(deriv = TRUE)

      expect_equal(v$val, rxSolve(rx, e, addDosing = TRUE)$cp[1])
    ...
    test_that("rxode2 solving of 1 compartment steady state for constant depot infusion", {
      ...
      expect_equal(f()$val, s$cp[1])

      expect_equal(f()$Alast, c(s$depot[1], s$central[1]))

      v <- f(deriv = TRUE)

      expect_equal(v$val, s$cp[1])

      expect_equal(v$Alast[1:2], c(s$depot[1], s$central[1]))
      ...
      expect_equal(f(rate = c(0, 600))$val, s$cp[1])

      expect_equal(f(rate = c(0, 600))$Alast, c(s$depot[1], s$central[1]))
    ...
    test_that("rxode2 solving of 1 compartment steady state for constant depot infusion", {
      f <- function(CL = 2, V = 25, DOSE = 600, tinf = 1, tau = 6, deriv = FALSE, cmt = 0L, ka = 0.25) {
        p1 <- CL
        v1 <- V
        p2 <- 0
        p3 <- 0
      ...
      expect_equal(f()$val, s$cp[1], tolerance = 1e-3)

      expect_equal(f()$Alast, c(s$depot[1], s$central[1]), tolerance = 1e-3)

      v <- f(deriv = TRUE)

      expect_equal(v$val, s$cp[1], tolerance = 1e-3)

      expect_equal(v$Alast[1:2], c(s$depot[1], s$central[1]), tolerance = 1e-3)
      ...
      expect_equal(f(cmt = 1L)$val, s$cp[1], tolerance = 1e-3)

      expect_equal(f(cmt = 1L)$Alast, c(s$depot[1], s$central[1]), tolerance = 1e-3)
    ...
    test_that("rxode2 solving of 2 compartment steady state bolus", {
      ...
      expect_equal(
        pmxTools::calc_ss_2cmt_linear_bolus(0, CL = 7.5, V1 = 20, V2 = 30, Q = 0.5, dose = 10, tau = 24),
        f()$val
      )
    ...
    test_that("rxode2 solving of 2 compartment steady state infusion", {
      ...
      expect_equal(
        pmxTools::calc_ss_2cmt_linear_infusion(
          tad = 0,
          CL = 7.5,
          V1 = 20,
          V2 = 30,
    ...
    test_that("rxode2 solving of 2 compartment steady state 1st order dosing", {
      ...
      expect_equal(
        f()$val,
        pmxTools::calc_ss_2cmt_linear_oral_1(
          tad = 0,
          CL = 7.5,
          V1 = 20,
          V2 = 30,
    ...
    test_that("rxode2 solving of 2 compartment steady state for constant infusion", {
      ...
      expect_equal(f()$val, rxSolve(rx, e, addDosing = TRUE)$cp[1], tolerance = 1e-3)

      v <- f(deriv = TRUE)

      expect_equal(v$val, rxSolve(rx, e, addDosing = TRUE)$cp[1], tolerance = 1e-3)
    ...
    test_that("rxode2 solving of 2 compartment steady state for constant depot infusion", {
      ...
      expect_equal(f()$Alast[1:3], c(s$depot[1], s$central[1], s$peripheral[1]), tolerance = 1e-3)

      v <- f(deriv = TRUE)

      expect_equal(v$val, s$cp[1], tolerance = 1e-3)

      expect_equal(v$Alast[1:3], c(s$depot[1], s$central[1], s$peripheral[1]), tolerance = 1e-3)
      ...
      expect_equal(f(rate = c(0, 600))$val, s$cp[1], tolerance = 1e-3)

      expect_equal(f(rate = c(0, 600))$Alast[1:3], c(s$depot[1], s$central[1], s$peripheral[1]), tolerance = 1e-3)
    ...
    test_that("rxode2 solving of 2 compartment steady state for constant depot infusion", {
      ...
      expect_equal(f()$Alast, c(s$depot[1], s$central[1], s$peripheral[1]), tolerance = 1e-3)
      ...
      expect_equal(f(cmt = 1L)$Alast, c(s$depot[1], s$central[1], s$peripheral[1]), tolerance = 1e-3)
    ...
    test_that("rxode2 solving of 3 compartment steady state bolus", {
      ...
      expect_equal(
        pmxTools::calc_ss_3cmt_linear_bolus(
          0,
          CL = 3.5,
          V1 = 20,
          V2 = 500,
    ...
    test_that("rxode2 solving of 3 compartment steady state 1st order dosing", {
      ...
      expect_equal(
        f()$val,
        pmxTools::calc_ss_3cmt_linear_oral_1(
          tad = 0,
          CL = 7.5,
          V1 = 20,
          V2 = 30,
    ...
    test_that("rxode2 solving of 3 compartment steady state for constant infusion", {
      ...
      f <- function(CL = 6, V = 25, V2 = 30, V3 = 200, Q2 = 0.5, Q3 = 0.05, DOSE = 600, deriv = FALSE) {
        p1 <- CL
        v1 <- V
        p2 <- Q2
        p3 <- V2
    ...
    test_that("rxode2 solving of 3 compartment steady state for constant depot infusion", {
      ...
      expect_equal(f()$Alast[1:4], c(s$depot[1], s$central[1], s$peripheral[1], s$peripheral1[1]), tolerance = 1e-3)

      v <- f(deriv = TRUE)

      expect_equal(v$val, s$cp[1], tolerance = 1e-3)

      expect_equal(v$Alast[1:4], c(s$depot[1], s$central[1], s$peripheral[1], s$peripheral1[1]), tolerance = 1e-3)
    ...
    test_that("rxode2 solving of 3 compartment steady state for constant depot infusion", {
      ...
      expect_equal(f()$Alast, c(s$depot[1], s$central[1], s$peripheral[1], s$peripheral1[1]), tolerance = 1e-3)
      ...
      expect_equal(f(cmt = 1L)$Alast, c(s$depot[1], s$central[1], s$peripheral[1], s$peripheral1[1]), tolerance = 1e-3)
