rxTest({
  ...
  solve1 <- function(p) {
    as.data.frame(rxode2::rxSolve(mod, params = p, ev, returnType = "data.frame", atol = 1e-12, rtol = 1e-12))
  }
  base <- solve1(p0)
  ...
  test_that("mixed third derivatives are symmetric in their variables", {
    ...
    expect_equal(base[[.nm("center", "ka", "cl", "v")]], base[[.nm("center", "v", "cl", "ka")]], tolerance = 1e-8)
    expect_equal(base[[.nm("center", "ka", "cl", "v")]], base[[.nm("center", "cl", "ka", "v")]], tolerance = 1e-8)
  })
})
