...
You can also write [C code inside your package and register it for use
with rxode2](rxode2-pkg-exported-funs.html) for a suite of functions
that may be useful to analysts.
