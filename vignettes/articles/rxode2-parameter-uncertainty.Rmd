...
(see [Summarizing simulations with confint()](rxode2-confint.html) for
the full set of options and for what `confint()` does when there is no
study dimension to work with):
