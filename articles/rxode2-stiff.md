...
```
    ...
    ## rxode2 5.0.0 model named rx_0a839587c0a82e220eecaf4a7ef2aab5 model (ready). 
    ## DLL: /tmp/RtmpfcHU7H/rxode2/rx_0a839587c0a82e220eecaf4a7ef2aab5__.rxd/rx_0a839587c0a82e220eecaf4a7ef2aab5_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
