...
```
    ...
    ## rxode2 5.0.0 model named rx_10d32498a5eabdc49ab8a9bdd18af3ba model (ready). 
    ## DLL: /tmp/RtmpEsdb9J/rxode2/rx_10d32498a5eabdc49ab8a9bdd18af3ba__.rxd/rx_10d32498a5eabdc49ab8a9bdd18af3ba_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
