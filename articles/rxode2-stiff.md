...
```
    ...
    ## rxode2 5.0.0 model named rx_94aba2d1f6cd83470a8ab9282f2f7de3 model (ready). 
    ## DLL: /tmp/Rtmp0IWJei/rxode2/rx_94aba2d1f6cd83470a8ab9282f2f7de3__.rxd/rx_94aba2d1f6cd83470a8ab9282f2f7de3_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
