...
```
    ...
    ## rxode2 5.0.0 model named rx_4be2c6a4ffbd2869a5d66536959e3aa6 model (ready). 
    ## DLL: /tmp/RtmpHc90nB/rxode2/rx_4be2c6a4ffbd2869a5d66536959e3aa6__.rxd/rx_4be2c6a4ffbd2869a5d66536959e3aa6_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
