...
```
    ...
    ## rxode2 5.0.0 model named rx_d823548637f4c1081cf18dd7abe10031 model (ready). 
    ## DLL: /tmp/Rtmp7cpkf5/rxode2/rx_d823548637f4c1081cf18dd7abe10031__.rxd/rx_d823548637f4c1081cf18dd7abe10031_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
