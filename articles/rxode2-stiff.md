...
```
    ...
    ## rxode2 5.0.0 model named rx_cbd26c79379df0eae5a7d820cc084520 model (ready). 
    ## DLL: /tmp/RtmpN7EouY/rxode2/rx_cbd26c79379df0eae5a7d820cc084520__.rxd/rx_cbd26c79379df0eae5a7d820cc084520_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
