...
```
    ...
    ## rxode2 5.0.0 model named rx_4ceb00f8c9da2f535fb0a4fda971a54c model (ready). 
    ## DLL: /tmp/RtmpcdJ02Q/rxode2/rx_4ceb00f8c9da2f535fb0a4fda971a54c__.rxd/rx_4ceb00f8c9da2f535fb0a4fda971a54c_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
