...
```
    ...
    ## rxode2 5.0.0 model named rx_6a9cf6d417b2c4f3a3da1d9ba254e1fe model (ready). 
    ## DLL: /tmp/RtmpvE5fw4/rxode2/rx_6a9cf6d417b2c4f3a3da1d9ba254e1fe__.rxd/rx_6a9cf6d417b2c4f3a3da1d9ba254e1fe_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
