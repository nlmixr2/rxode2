...
```
    ...
    ## rxode2 5.0.0 model named rx_8cf9fca4e9e86d76d4e592d761d4b1fa model (ready). 
    ## DLL: /tmp/Rtmp78EwGy/rxode2/rx_8cf9fca4e9e86d76d4e592d761d4b1fa__.rxd/rx_8cf9fca4e9e86d76d4e592d761d4b1fa_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
