...
```
    ...
    ## rxode2 5.0.0 model named rx_aea14534813acad22b29fae6ddb660c1 model (ready). 
    ## DLL: /tmp/RtmpzFce49/rxode2/rx_aea14534813acad22b29fae6ddb660c1__.rxd/rx_aea14534813acad22b29fae6ddb660c1_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
