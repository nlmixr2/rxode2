...
```
    ...
    ## rxode2 5.0.0 model named rx_eaf2976401c391c2e141da5edf2e17c7 model (ready). 
    ## DLL: /tmp/RtmpsM02jc/rxode2/rx_eaf2976401c391c2e141da5edf2e17c7__.rxd/rx_eaf2976401c391c2e141da5edf2e17c7_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
