...
```
    ...
    ## rxode2 5.0.0 model named rx_51fb009de60f4ae6f6404c7e6635d00f model (ready). 
    ## DLL: /tmp/RtmpYEiHDR/rxode2/rx_51fb009de60f4ae6f6404c7e6635d00f__.rxd/rx_51fb009de60f4ae6f6404c7e6635d00f_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
