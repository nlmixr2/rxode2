...
```
    ...
    ## rxode2 5.0.0 model named rx_c348d960fb1c1acd296f152dc94c9ccf model (ready). 
    ## DLL: /tmp/RtmpcjuTNT/rxode2/rx_c348d960fb1c1acd296f152dc94c9ccf__.rxd/rx_c348d960fb1c1acd296f152dc94c9ccf_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
