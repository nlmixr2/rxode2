...
```
    ...
    ## rxode2 5.0.0 model named rx_c61357f785b5e1fd754be1e1d8c82aaa model (ready). 
    ## DLL: /tmp/RtmpHiSxc9/rxode2/rx_c61357f785b5e1fd754be1e1d8c82aaa__.rxd/rx_c61357f785b5e1fd754be1e1d8c82aaa_.so
    ## NULL
    ## -- rxode2 Model Syntax --
    ## rxode2({
    ##     cmt(y)
