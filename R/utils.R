...
#' @rdname rxState
#' @export
rxState.function <- function(obj = NULL, state = NULL) {
  obj <- assertRxUi(obj)
  rxState(obj, state=state)
}

#' @rdname rxState
#' @export
rxState.rxUi <- function(obj = NULL, state = NULL) {
  rxState(obj$mv0, state=state)
}

#' @rdname rxState
#' @export
rxState.default <- function(obj = NULL, state = NULL) {
