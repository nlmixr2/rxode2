...
trunc = 1, bessel_i = 3, bessel_j = 2, bessel_k = 3, bessel_y = 2, 
logspace_add = 2, logspace_sub = 2, fmax2 = 2, fmin2 = 2, sign = 1, 
fsign = 2, fprec = 2, fround = 2, ftrunc = 1, transit = NA, gammaq = 2, 
gammapDer = 2, gammapInv = 2, gammapInva = 2, gammaqInv = 2, 
gammaqInva = 2, lowergamma = 2, uppergamma = 2, phiU = 1, gammapDera = 2, 
ibeta = 3, ibetaDer = 3, ibetaInv = 3, ibetaDera = 3, ibetaDerb = 3, 
studentTDen = 2, studentTCdf = 2, studentTCdfDnu = 2, studentTInv = 2, 
linCmtA = 14, linCmtB = 15, max = NA, min = NA, logit = NA, expit = NA, 
probit = NA, probitInv = NA, tlast = NA, tlast0 = NA, tfirst = NA, 
tfirst0 = NA, lag = NA, lead = NA, lag0 = NA, lead0 = NA, dose = NA, 
podo = NA, dose0 = NA, podo0 = NA, dabs = 1, dabs2 = 1, abs1 = 1, 
dabs1 = 1, erfinv = 1, abs0 = 1, dosenum = 0, first = 1, last = 1, 
diff = 1, diff0 = 1, is.nan = 1, is.na = 1, is.finite = 1, is.infinite = 1, 
