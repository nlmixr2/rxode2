...
"cos", "cosh", "erf", "erfc", "exp", "gamma", "log", "rxTBS", 
"rxTBSi", "rxTBSd", "rxTBSd2", "rxTBSdL", "rxTBSdL2", "rxTBSdLx", 
"sin", "sinh", "sqrt", "tan", "tanh", "gammap", "floor", "round", 
"ceil", "ceiling", "trunc", "bessel_i", "bessel_j", "bessel_k", 
...
"lowergamma", "uppergamma", "phiU", "gammapDera", "ibeta", "ibetaDer", 
"ibetaInv", "ibetaDera", "ibetaDerb", "studentTDen", "studentTCdf", 
"studentTCdfDnu", "studentTInv", "linCmtA", "linCmtB", "max", 
"min", "logit", "expit", "probit", "probitInv", "tlast", "tlast0", 
"tfirst", "tfirst0", "lag", "lead", "lag0", "lead0", "dose", 
"podo", "dose0", "podo0", "dabs", "dabs2", "abs1", "dabs1", "erfinv", 
"dosenum", "first", "last", "diff", "diff0", "is.nan", "is.na", 
...
"SELU", "dSELU", "lReLU", "dlReLU", "PReLU", "dPReLU", "dPReLUa", 
"dPReLUa1", "Swish", "dSwish", "linCmt", "rnorm", "rxnorm", "rxbinom", 
"rbinom", "rxcauchy", "rcauchy", "rchisq", "rxchisq", "rexp", 
"rxexp", "rbeta", "rxbeta", "rgeom", "rxgeom", "rxpois", "rpois", 
"rxt", "rt")
...
rxTBS = 5, rxTBSi = 5, rxTBSd = 5, rxTBSd2 = 5, rxTBSdL = 5, 
rxTBSdL2 = 5, rxTBSdLx = 5, sin = 1, sinh = 1, sqrt = 1, tan = 1, 
tanh = 1, gammap = 2, floor = 1, round = 1, ceil = 1, ceiling = 1, 
trunc = 1, digamma = 1, trigamma = 1, bessel_i = 3, bessel_j = 2, 
bessel_k = 3, bessel_y = 2, logspace_add = 2, logspace_sub = 2, 
fmax2 = 2, fmin2 = 2, sign = 1, fsign = 2, fprec = 2, fround = 2, 
ftrunc = 1, transit = NA, gammaq = 2, gammapDer = 2, gammapInv = 2, 
gammapInva = 2, gammaqInv = 2, gammaqInva = 2, lowergamma = 2, 
uppergamma = 2, phiU = 1, gammapDera = 2, ibeta = 3, ibetaDer = 3, 
ibetaInv = 3, ibetaDera = 3, ibetaDerb = 3, studentTDen = 2, 
studentTCdf = 2, studentTCdfDnu = 2, studentTInv = 2, linCmtA = 14, 
linCmtB = 15, max = NA, min = NA, logit = NA, expit = NA, probit = NA, 
probitInv = NA, tlast = NA, tlast0 = NA, tfirst = NA, tfirst0 = NA, 
lag = NA, lead = NA, lag0 = NA, lead0 = NA, dose = NA, podo = NA, 
dose0 = NA, podo0 = NA, dabs = 1, dabs2 = 1, abs1 = 1, dabs1 = 1, 
erfinv = 1, abs0 = 1, dosenum = 0, first = 1, last = 1, diff = 1, 
diff0 = 1, is.nan = 1, is.na = 1, is.finite = 1, is.infinite = 1, 
...
dPReLU = 2, dPReLUa = 2, dPReLUa1 = 2, Swish = 1, dSwish = 1)
