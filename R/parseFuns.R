...
"uppergamma", "linCmtA", "linCmtB", "max", "min", "logit", "expit", 
"probit", "probitInv", "tlast", "tlast0", "tfirst", "tfirst0", 
"lag", "lead", "lag0", "lead0", "dose", "podo", "dose0", "podo0", 
"dabs", "dabs2", "abs1", "dabs1", "erfinv", "dosenum", "first", 
"last", "diff", "diff0", "is.nan", "is.na", "is.finite", "is.infinite", 
...
fprec = 2, fround = 2, ftrunc = 1, transit = NA, gammaq = 2, 
