...
"gammaqInv", "gammaqInva", "lowergamma", "uppergamma", "max", 
"min", "logit", "expit", "probit", "probitInv", "tlast", "tlast0", 
"tfirst", "tfirst0", "lag", "lead", "dose", "podo", "dose0", 
"podo0", "dabs", "dabs2", "abs1", "dabs1", "erfinv", "abs0", 
"dosenum", "first", "last", "diff", "is.nan", "is.na", "is.finite", 
...
max = NA, min = NA, logit = NA, expit = NA, probit = NA, probitInv = NA, 
tlast = NA, tlast0 = NA, tfirst = NA, tfirst0 = NA, lag = NA, 
lead = NA, dose = NA, podo = NA, dose0 = NA, podo0 = NA, dabs = 1, 
