...
"lowergamma", "uppergamma", "linCmtA", "linCmtB", "max", "min", 
"logit", "expit", "probit", "probitInv", "tlast", "tlast0", "tfirst", 
"tfirst0", "lag", "lead", "lag0", "lead0", "dose", "podo", "dose0", 
"podo0", "dabs", "dabs2", "abs1", "dabs1", "erfinv", "dosenum", 
"first", "last", "diff", "diff0", "is.nan", "is.na", "is.finite", 
"is.infinite", "llikPois", "llikPoisDlambda", "llikBinom", "llikBinomDprob", 
...
gammaqInva = 2, lowergamma = 2, uppergamma = 2, linCmtA = 14, 
