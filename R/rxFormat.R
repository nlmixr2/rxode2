...
rxHtml.rxSolve <- function(x, ...) {
  ...
  if (!is.null(df)) {
    cat(paste0(
      "</td></tr><tr><td><strong>Covariates</strong> (<span style=\"color: Orange;\">",
      bound,
      "</span><strong \"color: Blue;\">&#36;covs</strong>):"
    ))
    cat(knitr::kable(head(as.matrix(df)), "html", ...))
  }
  cat(
    "</td></tr><tr><td><strong>Initial Conditions</strong> (<span style=\"color: Orange;\">",
    bound,
    "</span><strong \"color: Blue;\">&#36;inits</strong>):</td></tr><tr><td>"
  )
